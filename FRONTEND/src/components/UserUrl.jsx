...
const UserUrl = () => {
  ...
  useEffect(() => {
    if (tableRef.current) {
      gsap.fromTo(tableRef.current, { opacity: 0, y: 8 }, { opacity: 1, y: 0, duration: 0.5 })
    }
  }, [urls])
  ...
  return (
    <div ref={tableRef} className="bg-white dark:bg-gray-900 rounded-2xl mt-5 shadow-lg overflow-hidden border border-gray-100 dark:border-gray-800">
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-800">
            {urls.urls.reverse().map((url) => (
              <tr key={url._id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                ...
                <td className="px-6 py-4">
                  <div className="text-sm text-gray-900 dark:text-gray-100">
                    <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-violet-100 text-violet-800 dark:bg-violet-900/40 dark:text-violet-300">
