...
const LoginForm = ({ state }) => {
    ...
    return (
        <div className="w-full max-w-md mx-auto">
            <div ref={cardRef} className="bg-white/90 dark:bg-gray-900/80 backdrop-blur shadow-xl rounded-2xl px-8 pt-6 pb-8 mb-4 border border-gray-100 dark:border-gray-800">
